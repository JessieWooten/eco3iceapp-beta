        ...
        <div class="e3i-content-lg">
          <div class="status-container">
            ...
            <div v-if="status === 'ok'" class="status-wrapper">
              <img class="status-icon-inline" src="file:///android_asset/static/images/operation/status-ok.png">
              <p class="status-text-ok e3i-success">OK</p>
            </div>
            <!-- Status Low Flow -->
            <div v-else-if="status === 'low flow detected'" class="status-wrapper">
              <img class="status-icon" src="file:///android_asset/static/images/operation/status-warn.png">
            ...
            <div v-else-if="status === 'excessive flow detected'" class="status-wrapper">
              <div><img class="status-icon" src="file:///android_asset/static/images/operation/status-warn.png"></div>
        ...
        <div class="e3i-content-sm">
          <div class="health-container">
            ...
            <div v-if="health === 'good'" class="health-wrapper">
              <img class="health-icon" src="file:///android_asset/static/images/operation/health-good.png">
              <p class="health-text e3i-success">good</p>
            </div>
            <!-- Health Change Soon -->
            <div v-else-if="health === 'change soon'"class="health-wrapper">
              <img class="health-icon" src="file:///android_asset/static/images/operation/health-change-soon.png">
              <p class="health-text e3i-warn">change soon</p>
            </div>
            <!-- Health Change Now -->
            <div v-else-if="health === 'change now'" class="health-wrapper">
              <img class="health-icon" src="file:///android_asset/static/images/operation/health-change-now.png">
        ...
        <div class="e3i-content-sm">
          <div class="health-container">
            ...
            <div v-if="waterUsage != '---'" class="health-wrapper">
              <img class="water-icon" src="file:///android_asset/static/images/operation/water-drop.png">
